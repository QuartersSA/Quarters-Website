...
export async function GET(request) {
  try {
    ...
    return Response.json({ error: "فشل تحميل القوالب" }, { status: 500 });
  }
}
...
export async function POST(request) {
  try {
    ...
    if (!name) {
      return Response.json({ error: "اسم القالب مطلوب" }, { status: 400 });
    }
    if (!title) {
    ...
    return Response.json({ error: "فشل إنشاء القالب" }, { status: 500 });
  }
}
...
export async function DELETE(request) {
  try {
    ...
    if (!templateId) {
      return Response.json({ error: "templateId مطلوب" }, { status: 400 });
    }
    ...
    return Response.json({ error: "فشل حذف القالب" }, { status: 500 });
  }
}

...
export async function GET(request, { params }) {
  try {
    ...
    if (!taskId) {
      return Response.json({ error: "taskId غير صحيح" }, { status: 400 });
    }
    ...
    return Response.json({ error: "فشل تحميل القائمة" }, { status: 500 });
  }
}
...
export async function POST(request, { params }) {
  try {
    ...
    if (!title) {
      return Response.json({ error: "عنوان العنصر مطلوب" }, { status: 400 });
    }
    ...
    return Response.json({ error: "فشل إضافة العنصر" }, { status: 500 });
  }
}
...
export async function PATCH(request, { params }) {
  try {
    ...
    if (fields.length === 0) {
      return Response.json({ error: "لا يوجد تعديلات" }, { status: 400 });
    }
    ...
    return Response.json({ error: "فشل تعديل العنصر" }, { status: 500 });
  }
}
...
export async function DELETE(request, { params }) {
  try {
    ...
    return Response.json({ error: "فشل حذف العنصر" }, { status: 500 });
  }
}

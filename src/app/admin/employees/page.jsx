      ...
      <main className="mr-0 lg:mr-72 p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 mt-6 lg:mt-0">
          <div>
            ...
            >
              <Users className="w-8 h-8 sm:w-10 sm:h-10 text-emerald-700 dark:text-emerald-200" />
              إدارة الموظفين
            </h1>
        ...
        {loadErrorMessage ? (
          ...
          >
            ...
            <div className="text-slate-600 dark:text-slate-600 dark:dark:text-white/60 text-sm mt-1">

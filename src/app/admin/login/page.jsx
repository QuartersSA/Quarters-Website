      ...
      <div className="w-full max-w-md">
        ...
        <div className={`${ws.glass} ${ws.card} p-8`}>
          <div className="text-center mb-8">
            <div
              className={`${ws.iconBox} w-20 h-20 mx-auto mb-4 text-emerald-700 dark:text-emerald-700 dark:text-emerald-200`}
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label
                htmlFor="username"
                className="block text-sm font-semibold text-slate-700 dark:text-slate-700 dark:text-slate-700 dark:text-white/70 mb-2"
              >
                اسم المستخدم
              </label>
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2">
                  <User className="w-5 h-5 text-slate-500 dark:text-slate-500 dark:text-slate-500 dark:text-white/40" />
                </div>
                <input
                  id="username"
                  type="text"
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2">
                  <Lock className="w-5 h-5 text-slate-500 dark:text-slate-500 dark:text-slate-500 dark:text-white/40" />
                </div>
                <input
                  id="password"
                  type="password"
            ...
            {error ? (
              <div className="bg-red-500/10 border border-red-500/25 rounded-2xl p-3 backdrop-blur-sm flex items-start gap-2">
                <AlertCircle className="w-5 h-5 text-red-700 dark:text-red-700 dark:text-red-200 flex-shrink-0 mt-0.5" />
                <p className="text-red-700 dark:text-red-700 dark:text-red-200 text-sm">{error}</p>
              </div>
            ) : null}

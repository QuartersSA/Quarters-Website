      ...
      <main className="mr-0 lg:mr-72 p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
          <div className={statCard}>
            ...
            <p className="text-slate-600 dark:text-slate-600 dark:text-slate-600 dark:text-white/55 text-sm mb-1">إجمالي الفروع</p>
          ...
          <div className={statCard}>
            ...
            <p className="text-slate-600 dark:text-slate-600 dark:text-slate-600 dark:text-white/55 text-sm mb-1">فروع مع موقع</p>
            <p className="text-3xl font-bold text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white tracking-tight">
          ...
          <div className={statCard}>
            ...
            <p className="text-slate-600 dark:text-slate-600 dark:text-slate-600 dark:text-white/55 text-sm mb-1">إجمالي السجلات</p>
            <p className="text-3xl font-bold text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white tracking-tight">
              {branches.length}
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="flex-1 relative">
            <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 dark:text-slate-400 dark:text-slate-400 dark:text-white/35" />
            <input
              type="text"
        ...
        <div className={sectionCard}>
          <div className={`p-5 sm:p-6 border-b ${ws.divider}`}>
            <h2 className="text-xl font-bold text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white flex items-center gap-3 tracking-tight">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-slate-100 dark:bg-slate-100 dark:bg-slate-100 dark:bg-white/[0.04]">
                  ...
                  <th className="text-center px-6 py-4 text-sm font-semibold text-slate-600 dark:text-slate-600 dark:text-slate-600 dark:text-white/55">
                    الإجراءات
                  </th>
                </tr>
              </thead>
              <tbody>
                {isLoading ? (
                  ...
                  filteredBranches.map((branch, index) => (
                    ...
                    >
                      <td className="px-6 py-4 text-slate-500 dark:text-slate-500 dark:text-slate-500 dark:text-white/45">{index + 1}</td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div
                            className={`${ws.iconBox} w-10 h-10 text-slate-700 dark:text-slate-700 dark:text-slate-700 dark:text-white/75`}
                          >
                            <Building2 className="w-5 h-5" />
                          </div>
                      ...
                      <td className="px-6 py-4">
                        {branch.location ? (
                          <div className="flex items-center gap-2 text-slate-700 dark:text-slate-700 dark:text-slate-700 dark:text-white/75">
                            <MapPin className="w-4 h-4 text-emerald-700 dark:text-emerald-700 dark:text-emerald-200" />
                      ...
                      <td className="px-6 py-4 text-slate-500 dark:text-slate-500 dark:text-slate-500 dark:text-white/45 text-sm whitespace-nowrap">
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className={`${ws.glass} ${ws.card} w-full max-w-md shadow-2xl`}>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                <label className="block text-slate-700 dark:text-slate-700 dark:text-slate-700 dark:text-white/70 text-sm font-semibold mb-2">
                  اسم الفرع <span className="text-red-700 dark:text-red-700 dark:text-red-300">*</span>
                </label>
                <input
                  type="text"
                  required
          ...
          >
            ...
            <div className="p-6">
              <p className="text-slate-800 dark:text-white/80 mb-4">
                ...
                <span className="font-bold text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white">
                  "{deleteConfirm.name}"
                </span>
                ؟
              </p>
              <p className="text-amber-700 dark:text-amber-700 dark:text-amber-200/90 text-sm flex items-start gap-2 bg-amber-500/10 border border-amber-500/20 rounded-2xl p-3">

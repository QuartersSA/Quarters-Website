          ...
          <div className={`w-full max-w-xl ${ws.glass} ${ws.card} p-6`}>
            <div className="flex items-start gap-3">
              <div className={`${ws.iconBox} w-12 h-12`}>
                <AlertTriangle className="w-6 h-6 text-amber-700 dark:text-amber-700 dark:text-amber-200" />
              </div>
              <div>
                <div className="text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white text-xl font-bold tracking-tight">
                  لا توجد صلاحيات
                </div>
                <div className="text-slate-600 dark:text-slate-600 dark:text-slate-600 dark:text-white/60 mt-1">
                  هذا الحساب الإداري لا يملك أي صلاحية لعرض الأقسام (Workspace /
                  إدارة الجرد / Accounting / HR).
                </div>
                <div className="text-slate-500 dark:text-slate-500 dark:text-slate-500 dark:text-white/45 text-sm mt-3">
        ...
        <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          >
            <div className={`p-6 border-b ${ws.divider}`}>
              <div className="text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white text-2xl font-bold tracking-tight">
                اختر القسم
              </div>
              <div className="text-slate-600 dark:text-slate-600 dark:text-slate-600 dark:text-white/60 mt-2">
            ...
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {showInventoryBtn ? (
                <button
                  type="button"
                  onClick={goInventory}
                  className="p-5 rounded-3xl text-right transition-colors border border-slate-200 dark:border-slate-200 dark:border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-slate-50 dark:bg-slate-50 dark:bg-white/[0.03] hover:bg-slate-100 dark:hover:bg-slate-100 dark:hover:bg-slate-100 dark:hover:bg-white/[0.06]"
                >
                  <div className={`${ws.iconBox} mb-4`}>
                    <ClipboardList className="w-6 h-6 text-emerald-700 dark:text-emerald-700 dark:text-emerald-200" />
                  </div>
                  <div className="text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white font-bold text-lg tracking-tight">
                    إدارة الجرد
                  </div>
                  <div className="text-slate-600 dark:text-slate-600 dark:text-slate-600 dark:text-white/55 text-sm mt-1">
              ...
              {showWorkspaceBtn ? (
                ...
                >
                  <div className={`${ws.iconBox} mb-4`}>
                    <Briefcase className="w-6 h-6 text-sky-700 dark:text-sky-700 dark:text-sky-200" />
                  </div>
                  <div className="text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white font-bold text-lg tracking-tight">
                    Workspace
                  </div>
              ...
              {showAccountingBtn ? (
                ...
                >
                  <div className={`${ws.iconBox} mb-4`}>
                    <Calculator className="w-6 h-6 text-fuchsia-700 dark:text-fuchsia-700 dark:text-fuchsia-200" />
                  </div>
                  <div className="text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white font-bold text-lg tracking-tight">
                    Accounting
                  </div>
              ...
              {showHRBtn ? (
                ...
                >
                  <div className={`${ws.iconBox} mb-4`}>
                    <Users className="w-6 h-6 text-amber-700 dark:text-amber-700 dark:text-amber-200" />
                  </div>
                  <div className="text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white font-bold text-lg tracking-tight">
                    HR
                  </div>
              ...
              {showMarketingBtn ? (
                ...
                >
                  <div className={`${ws.iconBox} mb-4`}>
                    <Megaphone className="w-6 h-6 text-pink-700 dark:text-pink-700 dark:text-pink-200" />
                  </div>
                  <div className="text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white font-bold text-lg tracking-tight">
                    التسويق
                  </div>
            ...
            <div className="px-6 pb-6 text-xs text-slate-500 dark:text-slate-500 dark:text-slate-500 dark:text-white/45">

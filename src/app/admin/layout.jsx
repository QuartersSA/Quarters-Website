        ...
        <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className={`w-full max-w-xl ${ws.glass} ${ws.card} p-6`}>
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-slate-900 dark:text-white text-xl font-bold tracking-tight">
                  لا توجد صلاحيات
                </div>
                <div className="text-slate-600 dark:text-white/60 mt-1">
                  هذا الحساب الإداري لا يملك أي صلاحية لعرض الأقسام (Workspace /
                  إدارة الجرد / Accounting / HR).
                </div>
                <div className="text-slate-500 dark:text-white/45 text-sm mt-3">
        ...
        <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          >
            <div className={`p-6 border-b ${ws.divider}`}>
              <div className="text-slate-900 dark:text-white text-2xl font-bold tracking-tight">
                اختر القسم
              </div>
              <div className="text-slate-600 dark:text-white/60 mt-2">
            ...
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {showInventoryBtn ? (
                <button
                  type="button"
                  onClick={goInventory}
                  className="p-5 rounded-3xl text-right transition-colors border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/[0.03] hover:bg-slate-100 dark:hover:bg-white/[0.06]"
                >
            ...
            <div className="px-6 pb-6 text-xs text-slate-500 dark:text-white/45">

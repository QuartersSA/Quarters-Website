 ...
 * أسبوعي (كل اثنين عن الأسبوع الماضي) أو شهري (أول الشهر عن الشهر
 * الماضي). الإرسال يتم عند أول استخدام للنظام بعد الموعد — لا
 * يحتاج خادم مجدول. «أرسل الآن» يرسل ملخص آخر 30 يوماً للاختبار.
 */

const SCHEDULES_KEY = ["scheduled-purchase-reports"];

const FREQUENCY_OPTIONS = [
  { value: "monthly", label: "شهري — أول الشهر عن الشهر الماضي" },
  { value: "weekly", label: "أسبوعي — كل اثنين عن الأسبوع الماضي" },
];
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-500 dark:text-white/50 mt-0.5">
                ملخص المشتريات يصل تلقائياً كل أسبوع أو شهر.
              </div>
            </div>
          </div>
          <button

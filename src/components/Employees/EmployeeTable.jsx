          ...
          <tbody>
            {employees.map((employee) => {
              ...
              const workspaceBtnClass = employee.can_access_workspace
                ...
                : "bg-white/[0.04] text-white/60 border-white/10 hover:bg-white/[0.06]";
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-white/75" dir="ltr">
                    {employee.phone || "-"}
                  </td>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {tasks.map((t) => {
                          ...
                          return (
                            <span
                              key={t}
                              className={`${ws.pill} bg-white/[0.03] text-white/70 border-white/10 inline-flex items-center gap-1`}
                            >
                              {icon}
                              <span>{t}</span>
                            </span>

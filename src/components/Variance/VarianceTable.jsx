...
function getDeltaClass(delta) {
  ...
  if (n < -0.001) return "text-red-200";
  if (n > 0.001) return "text-emerald-200";
            ...
            <tbody>
              {rows.map((r) => {
                ...
                return (
                  ...
                  >
                    <td className="px-4 py-3 text-white/75 text-sm whitespace-nowrap" dir="ltr">
                      {formatDate(r.created_at)}
                    </td>
                    <td className="px-4 py-3 text-white/55 text-sm font-mono">
                      {r.inventory_number || "—"}
                    </td>
                    <td className="px-4 py-3 text-white text-sm font-semibold" dir="ltr">

    ...
    <div className={sectionCard}>
      ...
      {isLoading ? (
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 bg-slate-100 dark:bg-white/[0.04] rounded-2xl flex items-center justify-center border border-slate-200 dark:border-white/10">
                          <Package className="w-6 h-6 text-amber-700 dark:text-amber-200" />
                        </div>
                        <div>
                    ...
                    <td className="px-6 py-4">
                      ...
                      <span className="text-slate-500 dark:text-white/40 text-sm mr-1">
                        {item.unit || "حبة"}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-red-700 dark:text-red-200 font-bold">
                        -{shortage}
                      </span>
                      <span className="text-slate-500 dark:text-white/40 text-sm mr-1">
                        {item.unit || "حبة"}
        ...
        <div className="p-12 text-center text-slate-500 dark:text-white/50">
          <CheckCircle className="w-16 h-16 mx-auto mb-4 opacity-50 text-emerald-700 dark:text-emerald-200" />

...
export function OperationStatsCards({ stats }) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6" dir="rtl">
      <div className={card}>
        <div className={label}>
          <Hash className="w-4 h-4 text-slate-600 dark:text-slate-600 dark:dark:text-white/60" />
      ...
      <div className={card}>
        <div className={label}>
          <CheckCircle className="w-4 h-4 text-emerald-700 dark:text-emerald-700 dark:dark:text-emerald-200" />
      ...
      <div className={card}>
        <div className={label}>
          <X className="w-4 h-4 text-red-700 dark:text-red-700 dark:dark:text-red-200" />
      ...
      <div className={card}>
        <div className={label}>
          <Percent className="w-4 h-4 text-sky-700 dark:text-sky-700 dark:dark:text-sky-200" />

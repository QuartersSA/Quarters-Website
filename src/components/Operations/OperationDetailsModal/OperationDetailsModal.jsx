...
export function OperationDetailsModal({
  ...
  const titleIcon = isTransfer ? (
    <span className={`${ws.iconBox} w-10 h-10 text-amber-700 dark:text-amber-700 dark:text-amber-200`}>
      <ArrowLeftRight className="w-5 h-5" />
    </span>
  ) : isReceipt ? (
    <span className={`${ws.iconBox} w-10 h-10 text-emerald-700 dark:text-emerald-700 dark:text-emerald-200`}>
      ...
      >
        ...
        >
          <div className="min-w-0">
            <h3 className="text-lg sm:text-2xl font-bold text-slate-900 dark:text-slate-900 dark:text-white tracking-tight mb-1 flex items-center gap-2">
              {titleIcon}
              <span className="truncate">{titleText}</span>
            </h3>
            <p className="text-slate-500 dark:text-slate-500 dark:text-white/50 font-mono text-xs sm:text-sm truncate">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 min-h-0">
          {!operationDetails ? (
            <div className="py-16 text-center text-slate-600 dark:text-slate-600 dark:text-white/55">
            ...
            <>
              ...
              {isTransfer ? (
                <div className="bg-slate-100 dark:bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-slate-200 dark:border-white/10 rounded-2xl p-4 text-slate-700 dark:text-slate-700 dark:text-white/70 text-sm">
              ...
              {isReceipt ? (
                <div className="bg-emerald-500/5 border border-emerald-400/15 rounded-2xl p-4 text-slate-700 dark:text-slate-700 dark:text-white/70 text-sm">
        ...
        >
          ...
          {onEdit ? (
            ...
            >
              <Pencil className="w-4 h-4 sm:w-5 sm:h-5 text-sky-700 dark:text-sky-700 dark:text-sky-200" />
              <span>تعديل</span>
            </button>
          ) : null}
          {onDelete ? (

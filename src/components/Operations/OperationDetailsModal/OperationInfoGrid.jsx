...
export function OperationInfoGrid({ selectedOperation, totalQuantity }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="bg-slate-100 dark:bg-slate-100 dark:bg-white/5 rounded-lg p-4">
        ...
        {isTransfer && transferParties ? (
          ...
          <>
            <p className="text-slate-900 dark:text-slate-900 dark:text-white font-semibold flex items-center gap-2">
              <transferParties.Icon className="w-4 h-4 text-emerald-700 dark:text-emerald-700 dark:text-emerald-200" />
      ...
      <div className="bg-slate-100 dark:bg-slate-100 dark:bg-white/5 rounded-lg p-4">
        ...
        <p className="text-slate-700 dark:text-slate-700 dark:text-white/70 font-semibold">
      ...
      {totalQuantity !== undefined ? (
        <div className="bg-slate-100 dark:bg-slate-100 dark:bg-white/5 rounded-lg p-4">
          ...
          <p className="text-slate-900 dark:text-slate-900 dark:text-white font-semibold text-2xl">
            {totalQuantity}
      ...
      {selectedOperation.note ? (
        <div className="bg-slate-100 dark:bg-slate-100 dark:bg-white/5 rounded-lg p-4 md:col-span-2">
          <div className="flex items-center gap-2 text-gray-400 mb-2">
            <StickyNote className="w-4 h-4" />
            <span className="text-sm">ملاحظة</span>
          </div>
          <p className="text-slate-800 dark:text-slate-800 dark:text-white/85 whitespace-pre-wrap">
            {selectedOperation.note}
          </p>
        </div>
      ) : null}

...
export function AvailabilityProgressBar({ stats }) {
  return (
    ...
    >
      ...
      <div className="w-full bg-slate-200 dark:bg-white/10 rounded-full h-3 overflow-hidden border border-slate-200 dark:border-white/10">
        <div
      ...
      <div className="flex items-center justify-between mt-2 text-xs text-slate-500 dark:text-white/45">

...
export function Sidebar({ onLogout, activePage = "dashboard" }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed right-0 top-0 h-[100svh] w-72 lg:w-72 p-6 overflow-y-auto z-50 transition-transform duration-300 ${ws.glass} ${ws.card} rounded-l-[28px] lg:rounded-none border-l border-slate-200 dark:border-white/10 ${
          isMobileMenuOpen
            ? "translate-x-0"
      ...
      >
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-600 dark:text-white/55 text-xs">أنظمة Quarters</p>
        ...
        <nav className="space-y-2">
          <a
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-2xl transition-colors border ${
              activePage === "dashboard"
                ...
                : "text-slate-700 dark:text-white/70 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.06] border-transparent"
            }`}
          >
          ...
          <div>
            <button
              ...
              className="w-full flex items-center justify-between gap-3 px-4 py-3 text-slate-700 dark:text-white/70 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.06] rounded-2xl transition-colors border border-transparent"
            >
            ...
            {isInventorySummaryOpen && (
              <div className="mr-4 mt-2 space-y-1 border-r border-slate-200 dark:border-white/10 pr-3">
                <a

      ...
      >
        ...
        >
          <div className="min-w-0">
            <h3 className="text-slate-900 dark:text-white font-bold text-lg tracking-tight truncate">
              تسجيل مخزون افتتاحي
            </h3>
            <p className="text-slate-600 dark:text-white/55 text-sm">
        ...
        <div className="p-5">
          ...
          <div
            className={`max-h-[46vh] overflow-auto rounded-3xl border ${ws.divider} bg-slate-50 dark:bg-white/[0.02]`}
          >

...
export function HealthScoreCard({
  ...
  // Recharts <Cell fill="…"> is inline SVG — pick gauge "empty" ring per theme.
  const gaugeEmptyFill = isDark ? "rgba(255,255,255,0.05)" : "rgba(15,23,42,0.06)";

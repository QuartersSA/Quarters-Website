    ...
    <div className={`${ws.glassSoft} ${ws.card} p-4 sm:p-6 mb-6`}>
      <div className="flex flex-col lg:flex-row gap-3">
        ...
        <div className="min-w-[200px] flex items-center gap-2">
          <Building2 className="w-4 h-4 text-slate-500 dark:text-slate-500 dark:dark:text-white/45 shrink-0" />
          <GlassSelect
        ...
        <div className="min-w-[220px] flex items-center gap-2">
          <ArrowUpDown className="w-4 h-4 text-slate-500 dark:text-slate-500 dark:dark:text-white/45 shrink-0" />
          <GlassSelect
            value={sortBy}

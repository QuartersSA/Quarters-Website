  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
      <div className={statCard}>
        ...
        <p className="text-slate-600 dark:text-white/55 text-sm mb-1">إجمالي قيمة المخزون</p>
        <p className="text-3xl font-bold text-emerald-700 dark:text-emerald-200 tracking-tight">
          {fmtMoney(stats.totalValue)}{" "}
          <span className="text-base text-slate-500 dark:text-white/45 font-medium">ر.س</span>
        </p>
      </div>
      ...
      <div className={statCard}>
        ...
        <p className="text-slate-600 dark:text-white/55 text-sm mb-1">عدد الأصناف</p>
      ...
      <div className={statCard}>
        ...
        <p className="text-slate-600 dark:text-white/55 text-sm mb-1">أصناف بدون سعر</p>
      ...
      <div className={statCard}>
        ...
        <p className="text-slate-600 dark:text-white/55 text-sm mb-1">الأعلى قيمة</p>
        <p className="text-lg font-bold text-slate-900 dark:text-white truncate">
          {stats.topItemName || "—"}
        </p>
        {stats.topItemValue > 0 ? (
          <p className="text-xs text-purple-700 dark:text-purple-200 font-semibold mt-0.5">

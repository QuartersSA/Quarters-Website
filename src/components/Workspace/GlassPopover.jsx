  ...
  return createPortal(
    <>
      ...
      <div
        ...
        dir={dir}
        style={popoverStyle}
        className={`${ws.popover} rounded-2xl border border-slate-200 dark:border-slate-200 dark:border-white/15 shadow-2xl ${pos.maxHeight ? "" : "overflow-hidden"} ${className}`}
        onClick={(e) => {

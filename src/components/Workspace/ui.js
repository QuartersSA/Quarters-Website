...
export const ws = {
  ...
  appBg:
    ...
    // Dark: warm-olive gradient built from the brand anchor (#70765a).
    // Operator wanted the cool navy / near-black replaced with shades
    // pulled from the brand palette. Uses brand 700 → 800 → 900 so
    // the surface still reads as "dark mode" while taking on the
    // olive identity instead of the previous slate-navy.
    "dark:from-brand-800 dark:via-brand-700 dark:to-brand-900 dark:text-white",

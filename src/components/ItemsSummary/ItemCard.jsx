...
export function ItemCard({ item, isExpanded, onToggle }) {
  ...
  return (
    <div className="hover:bg-white/[0.04] transition-colors">
      {/* Item Header */}
      <div className="p-6 cursor-pointer" onClick={onToggle}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4 flex-1">
            {/* Item Icon */}
            <div className="w-16 h-16 bg-white/[0.04] rounded-2xl flex items-center justify-center border border-white/10 flex-shrink-0">
      ...
      {isExpanded ? (
        <div className="px-6 pb-6">
          <div
            className={`${ws.glassSoft} border border-white/10 rounded-3xl p-6`}
          >

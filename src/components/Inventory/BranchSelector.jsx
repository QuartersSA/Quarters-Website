  ...
  if (isLoading) {
    return (
      <div className={`${ws.glassSoft} ${ws.card} p-4`} dir="rtl">
        <div className="animate-pulse h-10 bg-slate-100 dark:bg-slate-100 dark:dark:bg-white/[0.06] rounded-2xl border border-slate-200 dark:border-slate-200 dark:dark:border-white/10" />
      </div>
    );
  }

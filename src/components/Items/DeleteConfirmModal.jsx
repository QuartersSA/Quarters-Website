      ...
      >
        ...
        <div className="p-6">
          <p className="text-white/80 mb-4">
            ...
            <span className="font-bold text-slate-900 dark:text-slate-900 dark:dark:text-white">"{item.name}"</span>؟
          </p>
          <p className="text-amber-700 dark:text-amber-200 text-sm flex items-start gap-2 bg-amber-500/10 border border-amber-500/20 rounded-2xl p-3">

      ...
      >
        ...
        >
          <div className="min-w-0">
            ...
            <p className="text-slate-600 dark:text-slate-600 dark:dark:text-white/55 text-sm mt-2 leading-relaxed">
        ...
        <div className="p-5 sm:p-6 overflow-y-auto flex-1">
          {errorMsg ? (
            <div className="mb-4 p-3 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-700 dark:text-red-200 text-sm flex items-start gap-2">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div
                        className={`w-10 h-10 rounded-2xl flex items-center justify-center border border-slate-200 dark:border-slate-200 dark:dark:border-white/10 ${
                      ...
                      <div className="min-w-0">
                        <p className="text-slate-900 dark:text-slate-900 dark:dark:text-white font-medium truncate">
                          {branch.name}
                        </p>
                        <p
                          className={`text-xs ${
                            isDisabled ? "text-red-700 dark:text-red-200" : "text-emerald-700 dark:text-emerald-200"
                          }`}
                        >

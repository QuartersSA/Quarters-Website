...
export function ItemFormModal({
  ...
  const labelClass = "block text-slate-700 dark:text-slate-700 dark:dark:text-white/70 text-sm font-semibold mb-2";
  const helpClass = "text-slate-500 dark:text-slate-500 dark:dark:text-white/40 text-xs mt-1";
      ...
      >
        ...
        >
          ...
          {isRoastedCoffeeCategory ? (
            ...
            >
              <label
                className={`${labelClass} flex items-center gap-2 text-amber-700 dark:text-amber-200/80`}
              >
              ...
              <p className="text-amber-700 dark:text-amber-200/40 text-xs mt-2">
          ...
          <div>
            <label className={labelClass}>
              اسم الصنف (عربي) <span className="text-red-700 dark:text-red-300">*</span>
            </label>
            <input
              type="text"
              required
          ...
          <div>
            <label className={`${labelClass} flex items-center gap-2`}>
              ...
              اسم الصنف (إنجليزي) <span className="text-red-700 dark:text-red-300">*</span>
            </label>
            <input
              type="text"
              required
          ...
          {/* Unit Selection */}
          <div>
            <label className="block text-slate-700 dark:text-slate-700 dark:dark:text-white/70 text-sm font-semibold mb-3">
              نوع المنتج (الوحدة) <span className="text-red-700 dark:text-red-300">*</span>
            </label>
            <div className="grid grid-cols-2 gap-3">
              {unitOptions.map((option, index) => {
                ...
                const boxClass = active
                  ...
                  : "bg-slate-50 dark:bg-slate-50 dark:dark:bg-white/[0.03] text-slate-700 dark:text-slate-700 dark:dark:text-white/70 border-slate-200 dark:border-slate-200 dark:dark:border-white/10 hover:bg-slate-100 dark:hover:bg-slate-100 dark:dark:hover:bg-white/[0.06]";
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span
                      className={`font-semibold ${active ? "text-slate-900 dark:text-slate-900 dark:dark:text-white" : "text-slate-700 dark:text-slate-700 dark:dark:text-white/70"}`}
                    >
                      {option.label}
                    </span>
                  </label>
          ...
          <div>
            <label className={labelClass}>
              الحد الأدنى للتنبيه <span className="text-red-700 dark:text-red-300">*</span>
            </label>
            <input
              type="number"
              required
          ...
          <div>
            <label className={labelClass}>
              الحد الأقصى للتنبيه{" "}
              <span className="text-slate-500 dark:text-slate-500 dark:dark:text-white/40 text-xs">(اختياري)</span>
            </label>
            <input
              type="number"
              min="0"
          ...
          <div
            className={`${ws.glassSoft} border border-slate-200 dark:border-slate-200 dark:dark:border-white/10 rounded-2xl p-5`}
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`${ws.iconBox} w-9 h-9 text-blue-700 dark:text-blue-200`}>
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-500 dark:dark:text-white/40 text-xs mt-0.5">

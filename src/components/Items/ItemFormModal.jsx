      ...
      >
        ...
        >
          ...
          {isRoastedCoffeeCategory ? (
            ...
            >
              <label
                className={`${labelClass} flex items-center gap-2 text-amber-200/80`}
              >
              ...
              {lastOrderInfo ? (
                <div className="mt-3 p-3 bg-amber-500/10 border border-amber-500/15 rounded-xl">
                  <p className="text-amber-200/80 text-xs">
                    ...
                    {lastOrderInfo.date ? (
                      <span className="text-amber-200/50 mr-2">
                        — {lastOrderInfo.date}
                      </span>
                    ) : null}
                  </p>
          ...
          <div>
            <label className={labelClass}>
              اسم الصنف (عربي) <span className="text-red-300">*</span>
            </label>
            <input
              type="text"
              required
          ...
          <div>
            <label className={`${labelClass} flex items-center gap-2`}>
              ...
              اسم الصنف (إنجليزي) <span className="text-red-300">*</span>
            </label>
            <input
              type="text"
              required
          ...
          <div>
            <label className={labelClass}>
              الحد الأدنى للتنبيه <span className="text-red-300">*</span>
            </label>
            <input
              type="number"
              required
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`${ws.iconBox} w-9 h-9 text-blue-200`}>

  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-8">
      <div className={`${ws.glass} ${ws.card} p-6`}>
        ...
        <p className="text-slate-600 dark:text-slate-600 dark:dark:text-slate-600 dark:dark:dark:text-white/55 text-sm mb-1">
        ...
        <p className="text-3xl font-bold text-slate-900 dark:text-slate-900 dark:dark:text-slate-900 dark:dark:dark:text-white tracking-tight">
          {items.length}
          {isFiltered ? (
            <span className="text-slate-500 dark:text-slate-500 dark:dark:text-slate-500 dark:dark:dark:text-white/40 text-base font-normal">
              {" "}
              / {totalCount}
            </span>
          ) : null}
      ...
      <div className={`${ws.glass} ${ws.card} p-6`}>
        ...
        <p className="text-slate-600 dark:text-slate-600 dark:dark:text-slate-600 dark:dark:dark:text-white/55 text-sm mb-1">متوفر</p>
      ...
      <div className={`${ws.glass} ${ws.card} p-6`}>
        ...
        <p className="text-slate-600 dark:text-slate-600 dark:dark:text-slate-600 dark:dark:dark:text-white/55 text-sm mb-1">منخفض</p>
      ...
      <div className={`${ws.glass} ${ws.card} p-6`}>
        <div className="flex items-center justify-between mb-4">
          <div className={`${ws.iconBox} text-red-700 dark:text-red-700 dark:dark:text-red-200`}>
            <XCircle className="w-6 h-6" />
          </div>
        </div>
        <p className="text-slate-600 dark:text-slate-600 dark:dark:text-slate-600 dark:dark:dark:text-white/55 text-sm mb-1">نفد</p>
        <p className="text-3xl font-bold text-red-700 dark:text-red-700 dark:dark:text-red-200 tracking-tight">
          {outOfStockItems}
        </p>
      </div>
    </div>

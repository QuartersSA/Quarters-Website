      ...
      >
        ...
        <div className="p-6 overflow-y-auto flex-1">
          <form onSubmit={onCreate} className="space-y-3">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="relative">
                <Languages className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-white/35" />
                <input
                  value={nameEn}
          ...
          <div className="mt-6">
            ...
            {sorted.length === 0 ? (
              <div className="p-6 text-center text-white/45 border border-white/10 rounded-3xl bg-white/[0.03]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {sorted.map((c) => {
                  ...
                  return (
                    <div
                      key={c.id}
                      className={`${ws.glassSoft} border border-white/10 rounded-2xl px-4 py-3`}
                    >
                      {!isEditing ? (
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            ...
                            <div
                              className="text-white/55 text-sm mt-1 truncate"
                              dir="ltr"
                            >
                              {c.name_en || "-"}
                            </div>

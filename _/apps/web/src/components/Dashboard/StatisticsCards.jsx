...
function StatCard({ icon, trend, label, value, accent = "emerald" }) {
  ...
  const iconColor = accentMap[accent] || "text-emerald-200";
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8">
        ...
        <div className={`${ws.glassSoft} ${ws.card} p-5`}>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-white/55 text-sm mb-1">آخر 7 أيام</p>
              <p className="text-2xl font-bold text-white tracking-tight">
        ...
        <div className={`${ws.glassSoft} ${ws.card} p-5`}>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-white/55 text-sm mb-1">نسبة اكتمال العمليات</p>
              <p className="text-2xl font-bold text-white tracking-tight">

    ...
    <div className={`${ws.glassSoft} border border-white/10 rounded-3xl p-4`}>
      ...
      >
        <div className="flex-1">
          ...
          {branch.branch_location ? (
            <p className="text-white/45 text-xs">{branch.branch_location}</p>
          ) : null}
        </div>
        <span
      ...
      <div className="mb-3">
        <div className="flex items-center justify-between mb-2">
          <span className="text-white/55 text-sm">الكمية الحالية</span>
      ...
      {branch.operation_id ? (
        <div className={`space-y-2 pt-3 border-t ${ws.divider}`}>
          <p className="text-xs font-semibold text-white/55 mb-2">
            آخر عملية جرد:
          </p>

          <div className="flex items-center gap-2">
            <Hash className="w-3 h-3 text-sky-200" />
            <span className="text-xs text-white/55">رقم الجرد:</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-white/55">التاريخ:</span>
          ...
          {branch.employee_name ? (
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-white/55">الموظف:</span>
              <span className="text-xs text-white">{branch.employee_name}</span>
            </div>
          ) : null}

          <div className="flex items-center gap-2">
            <FileText className="w-3 h-3 text-sky-200" />
            <span className="text-xs text-white/55">نوع الجرد:</span>
          ...
          <div className="flex items-center gap-2">
            <BarChart3 className="w-3 h-3 text-sky-200" />
            <span className="text-xs text-white/55">إجمالي العمليات:</span>

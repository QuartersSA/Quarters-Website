...
async function PUT(request, {
  ...
  try {
    ...
    `;
    const changedFields = {};
    const keys = ["name", "display_name", "phone", "iqama_number", "iqama_expiry_date", "sponsorship_transferred", "work_card_issued", "medical_check_issued", "health_card_issued", "health_card_expiry_date", "position", "base_salary", "other_allowances", "start_date"];

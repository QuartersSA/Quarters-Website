...
import { resetWhatsAppSession, requestWhatsAppPairingCode } from './whatsappBaileys-C7186LZR.js';
...
async function POST(request) {
  ...
  if ((process.env.WHATSAPP_PROVIDER || "").toLowerCase() !== "baileys") {
    return Response.json({
      error: "الوضع الذاتي غير مفعّل — اضبط WHATSAPP_PROVIDER=baileys في متغيرات الخادم أولاً"
    }, {
      status: 400
    });
  }

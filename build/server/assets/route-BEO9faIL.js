...
async function PUT(request, {
  ...
  try {
    ...
    const imagesProvided = body.images !== undefined || body.imageList !== undefined;
    const imagesArray = imagesProvided ? normalizeImagesArray(body.images ?? body.imageList) || [] : null;
    ...
    if (imagesProvided) {
      ...
      values.push(first?.sizeBytes === null || first?.sizeBytes === undefined ? null : Number(first.sizeBytes));

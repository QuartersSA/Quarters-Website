...
import { n as notifyAssigneesOnTaskWhatsApp, f as formatTaskLine, a as formatDateOnly, b as buildTaskLinkLine } from './_notify-CHOXlpS3.js';
import '@neondatabase/serverless';
import 'node:crypto';
import './wasender-D2lmIJ7B.js';
import './dateUtils-FqivhP-u.js';
...
async function fetchEmployeeNameMap(employeeIds) {
  ...
  const rows = await sql(`SELECT id, name FROM employees WHERE id IN (${placeholders.join(",")})`, vals);

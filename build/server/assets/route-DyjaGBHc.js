...
async function GET(request) {
  ...
  try {
    ...
    const orderClause = includeInactive ? "ORDER BY is_active DESC, name ASC" : "ORDER BY name ASC";
    const types = await sql(`SELECT id, name, scope, is_active, expected_amount, is_template
